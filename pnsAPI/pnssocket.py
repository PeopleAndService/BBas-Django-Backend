import socket
import time
from pnsApp.models import QueueData, PassengerAccount, DriverAccount, RatingData
from pnsApp.serializers import DriverSerializer, PassengerSerializer, QueueSerializer, RatingSerializer

host = '172.18.3.23' # 호스트 ip를 적어주세요
